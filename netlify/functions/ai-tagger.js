...
const MASTER_TAG_LIST = [
    ...
    'party', 'casual', 'edgy', 'girly', 'sexy',
    'cute', 'sporty', 'elegant', 'romantic',
    ...
    'going-out', 'date-night', 'festival', 'workwear',
    'retro', 'retro-sportswear', 'band-tee', 'graphic-sweatshirt', 'cable-knit', 'tailored',
    ...
    'ruched', 'smocked', 'tiered', 'ribbed', 'quilted',
